...
const portfolioList = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'HTML - 56,4%, CSS - 41,4%, JS - 2,0%',
      },
      {
        id: 2,
      ...
      },
      {
        ...
        name: 'Не реализовано',
        description:
          'Страница "О Седоне"; Слайдер в каталоге; Сортировка и вид карточек в каталоге; Динамическая загрузка карточек; Адаптивность',
      },
    ],
    images: [
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        id: 1,
        name: 'Использованные технологии',
        description: 'HTML - 39,5%, LESS - 56,3%, JS - 4,2%',
      },
      {
        id: 2,
        name: 'Сверстанные страницы',
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        id: 1,
        name: 'Использованные технологии',
        description: 'HTML - 0,9%, CSS - 1,4%, JS - 97,7%',
      },
      {
        id: 2,
        name: 'Сверстанные страницы',
