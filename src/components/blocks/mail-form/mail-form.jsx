    ...
    <MailStyled>
      <MailWrapperStyled>
        ...
        <MailFieldsWrapperStyled action='' method='post'>
          <MailInputStyled type='text' placeholder='Имя' $column='1 / 2' $row='1 / 2' />
          <MailInputStyled type='email' placeholder='E-mail' $column='1 / 2' $row='2 / 3' />
          <MailInputStyled type='text' placeholder='Текст сообщения' $column='2 / 3' $row='1 / 3' />
