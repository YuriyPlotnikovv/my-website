...
export default function About() {
  return (
    <StyledAbout>
      <Intro title='Обо мне' titleSize='extrabig' textOne='Я - начинающий фронтендер, живущий в Сочи.' textTwo='Активно развиваюсь в этом направлении с 2022 года. Не только центрирую div&#8242;ы, но и веду активный образ жизни.' image={image} />
      <PhotoList />
      <Skills />
      <AboutDetail />
      <MyWay />
